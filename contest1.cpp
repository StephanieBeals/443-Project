...
{
    ros::init(argc, argv, "robot_mapper");
    ros::NodeHandle nh;
    ...
    while (ros::ok() && secondsElapsed <= 480)
    {
        ...
        // Control logic based on the robot's position, orientation, laser scan, and bumper status.
        ...
        secondsElapsed = std::chrono::duration_cast<std::chrono::seconds>(end - start).count();
